						...
						<div>
							<c:forEach items="${ destination }" var="destination"
								...
								<div class="card mb-3 loca_${ destination.locationId }"
									...
									<div class="addDesti">
										<a class="material-icons">check</a> <input type="hidden"
...
<script>
	$("[class^='addDesti']").on("click", function(event) {
		 ...
		 * 
		 ...
		 console.log(JSON.stringify(destMapX));
		 console.log(JSON.stringify(destMapY));
		 console.log(JSON.stringify(destSubject));
		 console.log(JSON.stringify(destNo));
