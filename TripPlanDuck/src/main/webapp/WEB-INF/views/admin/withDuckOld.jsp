        ...
        <div class="row" style="margin-bottom: 25px;">
            ...
            <div class="col-4">
                <ul class="pagination justify-content-center">
                    <!-- 맨 처음으로 -->
					<button class="btn  btn-outline-warning btn-warning" onclick="location.href='${ path }/admin/withDuckOld?page=1'" 
					...
					<!-- 이전 페이지로 -->
					<button class="btn  btn-outline-warning btn-warning" onclick="location.href='${ path }/admin/withDuckOld?page=${ pageInfo.prevPage }'"
					 style="border: 1px; outline: none !important; box-shadow: none !important; border-radius: 12px; background-color: rgb(255,248,198); color: black;">
					 &lt;</button>
					...
					<c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status">
						...
						<c:if test="${ status.current != pageInfo.currentPage }">
							<button class="btn  btn-outline-warning btn-warning" onclick="location.href='${ path }/admin/withDuckOld?page=${ status.current }'" style="border: 1px; outline: none !important; box-shadow: none !important; border-radius: 12px; background-color: rgb(255,248,198); color: black;">
							${ status.current }</button>
						</c:if>
					</c:forEach>
					...
					<!-- 다음 페이지로 -->
					<button class="btn  btn-outline-warning btn-warning" onclick="location.href='${ path }/admin/withDuckOld?page=${ pageInfo.nextPage }'"
					 style="border: 1px; outline: none !important; box-shadow: none !important; border-radius: 12px; background-color: rgb(255,248,198); color: black;">
					 &gt;</button>
		
					<!-- 맨 끝으로 -->
					<button class="btn  btn-outline-warning btn-warning" onclick="location.href='${ path }/admin/withDuckOld?page=${ pageInfo.maxPage }'"
					 style="border: 1px; outline: none !important; box-shadow: none !important; border-radius: 12px; background-color: rgb(255,248,198); color: black;">
					 &gt;&gt;</button>
                </ul>
            </div>
