                ...
                <c:if test="${ not empty list }">
                	<c:forEach var="review" items="${list}">
                		<tr>
		                    ...
		                    <td>
	                        <button type="button" onclick="location.href='${path}/detail?reviewNo=${review.reportNoType}'" style="border: 1px; outline: none !important; box-shadow: none !important; border-radius: 12px; background-color: rgb(255,248,198); color: red;">
	                            리뷰삭제
	                        </button>
		                    </td>
		                </tr>
