        ...
        <div class="row" style="margin-bottom: 25px;">
            ...
            <div class="col-4">
                <ul class="pagination justify-content-center">
                    <!-- 맨 처음으로 -->
					<button class="btn" onclick="location.href='${ path }/admin/reviewLatest?page=1'" style="outline: none !important; box-shadow: none !important;">
					&lt;&lt;</button>
		
					<!-- 이전 페이지로 -->
					<button class="btn" onclick="location.href='${ path }/admin/reviewLatest?page=${ pageInfo.prevPage }'" style="outline: none !important; box-shadow: none !important;">
					 &lt;</button>
					...
					<c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status">
						...
						<c:if test="${ status.current != pageInfo.currentPage }">
							<button class="btn " onclick="location.href='${ path }/admin/reviewLatest?page=${ status.current }'" style="outline: none !important; box-shadow: none !important;" >
							${ status.current }</button>
						</c:if>
					</c:forEach>
					...
					<!-- 다음 페이지로 -->
					<button class="btn " onclick="location.href='${ path }/admin/reviewLatest?page=${ pageInfo.nextPage }'" style="outline: none !important; box-shadow: none !important;">
					 &gt;</button>
		
					<!-- 맨 끝으로 -->
					<button class="btn " onclick="location.href='${ path }/admin/reviewLatest?page=${ pageInfo.maxPage }'"
