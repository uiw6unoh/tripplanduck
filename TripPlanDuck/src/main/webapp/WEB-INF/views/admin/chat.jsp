...
<div class="container" style="margin-top: 70px; margin-bottom: 70px;">
    ...
    <div class="col-sm-10" style="border: 3px solid rgb(221, 221, 221);">
        ...
        <h2 style="margin-top: 15px;">채팅 관리</h2>
        ...
        <div class="row">
            <div class="col-md-6">
                        ...
                        </svg> 회원삭제 버튼을 클릭 시 비회원으로 전환됩니다.</p>
            </div>
            <div class="col-md-6">
                <form action="...">
                    <button style="margin-top: 25px; margin-left: 150px; outline: none !important; box-shadow: none !important; border: 1px; border-radius: 12px; background-color: rgb(255,248,198);">최신순</button>
                    <button style="border: 1px; outline: none !important; box-shadow: none !important; border-radius: 12px; background-color: rgb(255,248,198);">신고받은채팅</button>
            ...
            <table class="table table-sm">
                <thead>
                    <tr style="height: 10px; color:gray">
                        <th style="width: 20%;">채팅 번호</th>
                        <th style="width: 30%;">채팅 제목</th>
                        <th style="width: 15%;">아이디</th>
                        <th style="width: 15%;">신고</th>
                        <th style="width: 15%;">채팅 정지</th>
                    </tr>
                </thead>
