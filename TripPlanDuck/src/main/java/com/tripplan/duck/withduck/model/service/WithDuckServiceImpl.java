...
public class WithDuckServiceImpl implements WithDuckService {
	...
	@Override
	public List<WithDuck> withDuckFilter(PageInfo pageInfo, String location_val, String gender_val, String age_val) {
		int offset = (pageInfo.getCurrentPage() - 1) * pageInfo.getListLimit();
		int limit = pageInfo.getListLimit();
		RowBounds rowBounds = new RowBounds(offset, limit);
		
		return mapper.withDuckFilter(rowBounds, location_val, gender_val, age_val);
	}

	@Override
	public int getWithDuckFilterCount(String location_val, String gender_val, String age_val) {
		return mapper.selectWithDuckFilterCount(location_val, gender_val, age_val);
	}
